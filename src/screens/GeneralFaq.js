        ...
        return (
            <View style={{
                ...
                <RegularText customstyle={{
                    color: '#372AA4', fontFamily: "BR Firma Bold", fontSize: RFValue(15), flex: 1, marginRight: RFValue(8), lineHeight: RFValue(20),
    ...
    _renderContent = section => {
        return (
            <View style={{ marginVertical: RFValue(4), paddingHorizontal: RFValue(16), }}>
                <RegularText customstyle={{
                    color: '#0A2240', fontFamily: "BR Firma Regular", fontSize: RFValue(14), lineHeight: RFValue(20), marginLeft: RFValue(15)
                }}>{section.content}</RegularText>
            </View>
        );
    }
    ...
    render() {
        return (
            <View style={Styles.background2}>
                ...
                <ImageBackground source={require('../assets/image/backgroundIcons.png')} resizeMode="contain" style={{ ...Styles.generalHeader, }}>
                    <Image source={require('../assets/image/donut_large.png')} resizeMode="contain" style={{ width: RFValue(24), height: RFValue(24), }} />
                    <MediumText customstyle={{ color: '#FFFFFF', fontSize: RFValue(15), lineHeight: RFValue(30), marginLeft: RFValue(15), fontFamily: 'BR Firma Bold' }}>General</MediumText>
                </ImageBackground>
                <View style={{ flex: 1, backgroundColor: '#F4F5F7', borderTopStartRadius: RFValue(15), borderTopEndRadius: RFValue(15), width: '100%' }}>
                    <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingTop: RFValue(15), paddingHorizontal: RFValue(10) }}>
                        ...
                        <View style={{
                            ...
                            <MediumText customstyle={{ color: '#2F2F2F', fontSize: RFValue(15), lineHeight: RFValue(16), fontFamily: "BR Firma Bold" }}>Other Categories</MediumText>
                        </View>
                        ...
                        <TouchableOpacity onPress={() => this.props.navigation.navigate('ProductFaq')} style={Styles.item}>
                            <View style={Styles.itemLeft}>
                                <View style={Styles.square}>
                                    <Image source={require('../assets/image/dashboard.png')} resizeMode="contain" style={{ width: RFValue(30), height: RFValue(30), }}  >

                                    </Image>
                                </View>
                                <RegularText style={Styles.itemText}>{"Product"}</RegularText>
                            </View>
                            <View style={Styles.circular}>
                                <Image source={require('../assets/image/rightArrow.png')} resizeMode="contain" style={{ width: RFValue(12), height: RFValue(12) }}  >
