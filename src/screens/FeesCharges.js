...
class FeesChargesFaq extends Component {
    componentDidMount() {
        ...
        return (
            <View style={{
                ...
                <RegularText customstyle={{
                    color: '#372AA4', fontSize: RFValue(15), fontFamily: "BR Firma Bold", flex: 1, marginRight: RFValue(8), lineHeight: RFValue(20),
    ...
    render() {
        return (
            <View style={Styles.background2}>
                ...
                <ImageBackground source={require('../assets/image/backgroundIcons.png')} resizeMode="contain" style={{ ...Styles.feesChargesHeader, }}>
                    <Image source={require('../assets/image/donut_large.png')} resizeMode="contain" style={{ width: RFValue(24), height: RFValue(24), }} />
                    <MediumText customstyle={{ color: '#FFFFFF', fontSize: RFValue(15), lineHeight: RFValue(30), marginLeft: RFValue(15), fontFamily: "BR Firma Bold", }}>Fees and Charges</MediumText>
                </ImageBackground>
                <View style={{ flex: 1, backgroundColor: '#F4F5F7', borderTopStartRadius: RFValue(15), borderTopEndRadius: RFValue(15), width: '100%' }}>
                    <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingTop: RFValue(15), paddingHorizontal: RFValue(10) }}>
                        ...
                        <View style={{
                            ...
                            <MediumText customstyle={{ color: '#2F2F2F', fontSize: RFValue(15), lineHeight: RFValue(16), fontWeight: '700', fontFamily: "BR Firma Bold", }}>Other Categories</MediumText>
                        </View>
                        <TouchableOpacity onPress={() => this.props.navigation.navigate("ReportIssue")} style={Styles.item}>
                            <View style={Styles.itemLeft}>
