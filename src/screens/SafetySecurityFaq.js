...
class SafetySecurityFaq extends Component {
    componentDidMount() {
    ...
    render() {
        return (
            <View style={Styles.background2}>
                ...
                <ImageBackground source={require('../assets/image/backgroundIcons.png')} resizeMode="contain" style={{ ...Styles.safetyHeader, }}>
                    <Image source={require('../assets/image/security.png')} resizeMode="contain" style={{ width: RFValue(24), height: RFValue(24), }} />
                    <MediumText customstyle={{ color: '#FFFFFF', fontSize: RFValue(15), lineHeight: RFValue(30), marginLeft: RFValue(15), fontFamily: "BR Firma Bold", }}>Safety and Security</MediumText>
                </ImageBackground>
                <View style={{ flex: 1, backgroundColor: '#F4F5F7', borderTopStartRadius: RFValue(15), borderTopEndRadius: RFValue(15), width: '100%' }}>
                    <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingTop: RFValue(15), paddingHorizontal: RFValue(10) }}>
                        ...
                        <TouchableOpacity onPress={() => this.props.navigation.navigate("GeneraFaq")} style={Styles.item}>
                            <View style={Styles.itemLeft}>
...
export default SafetySecurityFaq;
